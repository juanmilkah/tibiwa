...
export const MockBlogs: Blog[] = [
  {
    ...
    category : "Research",
    content :
        `In a groundbreaking study published this week, researchers have identified a new mechanism for targeting cancer cells that could revolutionize treatment approaches. The study, conducted over three years with a diverse patient group, showed remarkable results in early trials.
  ...
  },
  {
    ...
    content :
        "The integration of AI in modern healthcare is creating a paradigm shift that promises improved patient outcomes, enhanced operational efficiency, and groundbreaking advancements in research and development. As technology continues to evolve, the potential for AI to further shape the future of healthcare is immense, making it an exciting field to watch. Embracing these changes will be crucial for healthcare professionals, policymakers, and patients alike as we navigate this transformative era.",
    authorId : "3",
